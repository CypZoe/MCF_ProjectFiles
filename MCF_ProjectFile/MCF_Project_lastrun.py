...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Cypri\\OneDrive\\Documents\\MCF_ProjectFile\\MCF_Project_lastrun.py',
...
text_7 = visual.TextStim(win=win, name='text_7',
    text="In this experiment you will be presented with 10 vignettes (a brief account of a situation) and 10 images, in a randomized order. You will be required to respond with the degree of positive or negative emotions evoked using a slider. \nBefore the experiment starts, you will be able to test how the slider works. \n\nPress the 'y' key if you understand the instructions and want to move forward.",
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
for thisTrial_2 in trials_2:
    ...
    _key_resp_7_allKeys = []
    # keep track of which components have finished
    PartOne_2Components = [text_8, slider_3, key_resp_7]
